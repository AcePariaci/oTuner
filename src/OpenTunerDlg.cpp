...
COpenTunerDlg::COpenTunerDlg(HINSTANCE hInstance, HWND hParent) :
    ...
    m_ReferenceAFrequencyHundreds(4),
    m_ReferenceAFrequencyTens    (4),
    m_ReferenceAFrequencyOnes    (0) 
{
    memset(&m_ahdcBmpNumbers     , 0, sizeof(m_ahdcBmpNumbers    ));
    memset(&m_ahOldObjBmpNumbers , 0, sizeof(m_ahOldObjBmpNumbers));
    memset(&m_ahdcmBmpNumbers    , 0, sizeof(m_ahdcmBmpNumbers    ));
    memset(&m_ahOldObjmBmpNumbers, 0, sizeof(m_ahOldObjmBmpNumbers));
    ...
    m_ahmBmpNumbers[0] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_0  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[1] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_1  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[2] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_2  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[3] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_3  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[4] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_4  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[5] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_5  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[6] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_6  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[7] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_7  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[8] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_8  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    m_ahmBmpNumbers[9] = (HBITMAP)LoadImage(m_hInstance, MAKEINTRESOURCE(IDB_BITMAP_OCTAV_9  ), IMAGE_BITMAP,0,0, LR_DEFAULTCOLOR);
    ...
    ADD_MSG_HANDLER(WM_LBUTTONDOWN, OnLButtonDown);
    ADD_MSG_HANDLER(WM_RBUTTONDOWN, OnRButtonDown);
...
COpenTunerDlg::~COpenTunerDlg()
{
    ...
    SelectObject(m_ahdcmBmpNumbers[0], m_ahOldObjmBmpNumbers[0]); DeleteDC(m_ahdcmBmpNumbers[0]); m_ahdcmBmpNumbers[0] = 0; DeleteObject (m_ahmBmpNumbers[0]); m_ahmBmpNumbers[0] = NULL;
    SelectObject(m_ahdcmBmpNumbers[1], m_ahOldObjmBmpNumbers[1]); DeleteDC(m_ahdcmBmpNumbers[1]); m_ahdcmBmpNumbers[1] = 0; DeleteObject (m_ahmBmpNumbers[1]); m_ahmBmpNumbers[1] = NULL;
    SelectObject(m_ahdcmBmpNumbers[2], m_ahOldObjmBmpNumbers[2]); DeleteDC(m_ahdcmBmpNumbers[2]); m_ahdcmBmpNumbers[2] = 0; DeleteObject (m_ahmBmpNumbers[2]); m_ahmBmpNumbers[2] = NULL;
    SelectObject(m_ahdcmBmpNumbers[3], m_ahOldObjmBmpNumbers[3]); DeleteDC(m_ahdcmBmpNumbers[3]); m_ahdcmBmpNumbers[3] = 0; DeleteObject (m_ahmBmpNumbers[3]); m_ahmBmpNumbers[3] = NULL;
    SelectObject(m_ahdcmBmpNumbers[4], m_ahOldObjmBmpNumbers[4]); DeleteDC(m_ahdcmBmpNumbers[4]); m_ahdcmBmpNumbers[4] = 0; DeleteObject (m_ahmBmpNumbers[4]); m_ahmBmpNumbers[4] = NULL;
    SelectObject(m_ahdcmBmpNumbers[5], m_ahOldObjmBmpNumbers[5]); DeleteDC(m_ahdcmBmpNumbers[5]); m_ahdcmBmpNumbers[5] = 0; DeleteObject (m_ahmBmpNumbers[5]); m_ahmBmpNumbers[5] = NULL;
    SelectObject(m_ahdcmBmpNumbers[6], m_ahOldObjmBmpNumbers[6]); DeleteDC(m_ahdcmBmpNumbers[6]); m_ahdcmBmpNumbers[6] = 0; DeleteObject (m_ahmBmpNumbers[6]); m_ahmBmpNumbers[6] = NULL;
    SelectObject(m_ahdcmBmpNumbers[7], m_ahOldObjmBmpNumbers[7]); DeleteDC(m_ahdcmBmpNumbers[7]); m_ahdcmBmpNumbers[7] = 0; DeleteObject (m_ahmBmpNumbers[7]); m_ahmBmpNumbers[7] = NULL;
    SelectObject(m_ahdcmBmpNumbers[8], m_ahOldObjmBmpNumbers[8]); DeleteDC(m_ahdcmBmpNumbers[8]); m_ahdcmBmpNumbers[8] = 0; DeleteObject (m_ahmBmpNumbers[8]); m_ahmBmpNumbers[8] = NULL;
    SelectObject(m_ahdcmBmpNumbers[9], m_ahOldObjmBmpNumbers[9]); DeleteDC(m_ahdcmBmpNumbers[9]); m_ahdcmBmpNumbers[9] = 0; DeleteObject (m_ahmBmpNumbers[9]); m_ahmBmpNumbers[9] = NULL;
...
long COpenTunerDlg::OnLButtonDown (unsigned long wIgnore, long lIgnore) 
{
    if (m_ReferenceAFrequencyOnes < 9)
        ++m_ReferenceAFrequencyOnes;
    else
    {
        if (m_ReferenceAFrequencyTens == 3)
            m_ReferenceAFrequencyTens = 4;
        else
            m_ReferenceAFrequencyTens = 3;
        m_ReferenceAFrequencyOnes = 0;
    }
    m_autopCore->SetReferenceFrequency(m_ReferenceAFrequencyHundreds*100+m_ReferenceAFrequencyTens*10+m_ReferenceAFrequencyOnes);
    return 1;
}
//--------------------------------------------------------------------------------------------------


long COpenTunerDlg::OnRButtonDown (unsigned long wIgnore, long lIgnore) 
{
    if (m_ReferenceAFrequencyOnes > 0)
        --m_ReferenceAFrequencyOnes;
    else
    {
        if (m_ReferenceAFrequencyTens == 3)
...
long COpenTunerDlg::OnPaint(unsigned long pfPitch, long pfVolume)
{
    ...
    if (m_hdcBmpTitleLHS == NULL)
    {
        ...
        m_ahdcmBmpNumbers[0] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[0] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[0], m_ahmBmpNumbers[0]);
        m_ahdcmBmpNumbers[1] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[1] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[1], m_ahmBmpNumbers[1]);
        m_ahdcmBmpNumbers[2] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[2] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[2], m_ahmBmpNumbers[2]);
        m_ahdcmBmpNumbers[3] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[3] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[3], m_ahmBmpNumbers[3]);
        m_ahdcmBmpNumbers[4] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[4] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[4], m_ahmBmpNumbers[4]);
        m_ahdcmBmpNumbers[5] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[5] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[5], m_ahmBmpNumbers[5]);
        m_ahdcmBmpNumbers[6] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[6] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[6], m_ahmBmpNumbers[6]);
        m_ahdcmBmpNumbers[7] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[7] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[7], m_ahmBmpNumbers[7]);
        m_ahdcmBmpNumbers[8] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[8] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[8], m_ahmBmpNumbers[8]);
        m_ahdcmBmpNumbers[9] = CreateCompatibleDC(hdc); m_ahOldObjmBmpNumbers[9] = (HBITMAP) SelectObject(m_ahdcmBmpNumbers[9], m_ahmBmpNumbers[9]);
    ...
    if (m_iNoteName >= 0)
    {
        ...
        if ((m_nOctave >= 0) && (m_nOctave <= 9))
            BitBlt(hdc, m_BmpArrowEmpRHSWidth *11 + m_BmpLettersWidth/2, m_BmpLettersHeight/2, m_BmpLettersWidth   , m_BmpLettersHeight   , m_ahdcmBmpNumbers[m_nOctave], 0, 0, SRCPAINT);
    }
    else
...
//        pitchHist.clear();
    ...
    if(valid) 
    {
        m_iNoteName = cycle(toInt(pitch), 12, &m_nOctave); //m_iNoteName: 0 is C, 1 is C#, etc.
